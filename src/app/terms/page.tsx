      ...
      <div className="max-w-2xl mx-auto px-6 py-12 space-y-8">
        ...
        <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
          <section className="space-y-3">
            <h2 className="text-lg font-heading font-semibold text-text">Acceptance of Terms</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-heading font-semibold text-text">The Service</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-heading font-semibold text-text">Your Account</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-heading font-semibold text-text">Your Content</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-heading font-semibold text-text">Acceptable Use</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-heading font-semibold text-text">Subscriptions & Payments</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-heading font-semibold text-text">Limitation of Liability</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-heading font-semibold text-text">Changes to Terms</h2>
