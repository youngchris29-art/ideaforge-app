      ...
      <div className="max-w-2xl mx-auto px-6 py-12 space-y-8">
        ...
        <div className="space-y-6 text-sm text-text-secondary leading-relaxed">
          <section className="space-y-3">
            <h2 className="text-lg font-heading font-semibold text-text">What We Collect</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-heading font-semibold text-text">How We Use Your Data</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-heading font-semibold text-text">Your Ideas Are Private</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-heading font-semibold text-text">Third-Party Services</h2>
            <p>IdeaForge uses the following third-party services to operate:</p>
            <div className="space-y-1 pl-4">
              <p><strong className="text-text">Clerk</strong> — Authentication and user management</p>
              <p><strong className="text-text">Convex</strong> — Database and backend infrastructure</p>
              <p><strong className="text-text">Anthropic (Claude)</strong> — AI conversation processing</p>
              <p><strong className="text-text">Polar</strong> — Payment processing</p>
              <p><strong className="text-text">Vercel</strong> — Web hosting</p>
            </div>
            <p>Each of these services has their own privacy policies and data handling practices.</p>
          </section>

          <section className="space-y-3">
            <h2 className="text-lg font-heading font-semibold text-text">Data Retention & Deletion</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-heading font-semibold text-text">Cookies</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-heading font-semibold text-text">Contact</h2>
